...
class GeneticAlgorithm
{
    ...
    public function inisialisasiPopulasi($jumlahIndividu, $jumlahJam, $jumlahHari, $jumlahRuangan)
    {
        ...
        $pengampus = Pengampu::with('matkul', 'kelas')->limit(20)->get();
        ...
        //dibawah ini code tambahan dan boleh dihapus.
        // //Log::info('Populasi Inisialisasi', ['populasi' => $populasi]);
    ...
    public function evaluasiFitness($individu, $jumlahHari)
    {
        ...
        // dibawah ini code tambahan dan boleh dihapus.
        //Log::info('Fitness Dihitung', ['fitness' => $fitness, 'conflicts' => $conflicts]);
    ...
    public function crossover($individu1, $individu2)
    {
        ...
        //dibawah ini code baru dan boleh dihapus.
        //Log::info('Hasil Crossover', ['anak1' => $anak1, 'anak2' => $anak2]);
    ...
    public function mutasi($individu, $jumlahJam, $jumlahHari, $jumlahRuangan)
    {
        ...
        // dibawah ini code baru dan boleh dihapus.
        //Log::info('Individu Setelah Mutasi', ['individu' => $individu]);
