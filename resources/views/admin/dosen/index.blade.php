                                ...
                                <form id="add-dosen-form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="prodi" name="prodi" required>
                                            ...
                                            <option value="D4 Teknik Komputer Jaringan">D4 Teknik Komputer Jaringan</option>
                                            <option value="D4 Teknik Multimedia Jaringan">D4 Teknik Multimedia Jaringan
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <form id="edit-dosen-form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="edit-prodi" name="edit-prodi" required>
                                            <option selected disabled>Select Prodi</option>
                                            <option value="D4 Teknik Komputer Jaringan">D4 Teknik Komputer Jaringan</option>
                                            <option value="D4 Teknik Multimedia Jaringan">D4 Teknik Multimedia Jaringan</option>
                                    </div>
